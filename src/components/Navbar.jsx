    ...
    <nav className="bg-[#A656A6] text-white shadow-md sticky top-0 z-40">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link to="/products" className="hover:text-purple-200 transition">Products</Link>
          <Link to="/products?cat=women" className="hover:text-purple-200 transition">Women</Link>
          <Link to="/products?cat=men" className="hover:text-purple-200 transition">Men</Link>
          <Link to="/products?cat=unisex" className="hover:text-purple-200 transition">Unisex</Link>
